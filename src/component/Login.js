import { Button, Checkbox, Box, Link,FormControlLabel,TextField, Grid, Typography, Container } from "@mui/material";
...
function Login(){
    ...
    return(
            <Container component='main' maxWidth='xs' sx={{mt:15, padding:1 ,backgroundColor:'#ededed'}}>
                <Box sx={{marginTop: 8, display: 'flex', flexDirection: 'column', alignItems:'center'}}>
                    ...
                    <FormControlLabel control={<Checkbox value='remember' color="primary"/>}  label={<Typography sx={{color:'#999'}}>로그인정보 기억하기</Typography>}/>
